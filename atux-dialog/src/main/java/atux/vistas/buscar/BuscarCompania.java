...
public class BuscarCompania extends javax.swing.JPanel {
    ...
    public BuscarCompania(int Seleccion) {
        initComponents();
        ...
        mtp = new ModeloTablaCompania(opcion);
        
        tblListado.setModel(mtp);
        Helper.ajustarSoloAnchoColumnas(tblListado,ModeloTablaCompania.anchoColumnas);        
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(26, 26, 26)
                .addComponent(rbDocumento, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if(!txtDato.getText().isEmpty()){
            ...
            if(this.rbRazonSocial.isSelected()){
                Condicion=" DE_COMPANIA like '%" + txtDato.getText() + "%' ";
            }else if(this.rbDocumento.isSelected()){
                Condicion=" NU_RUC_COMPANIA like '%" + txtDato.getText() + "%' ";
            }
            if(opcion != -1){
                Condicion = Condicion + " and ES_Compania = '" + Estado + "'";
            } 
            
            this.mtp = new ModeloTablaCompania(Condicion);
            ...
            switch(opcion)
            {
                case 0:
                case 1:
                    mtp = new ModeloTablaCompania(opcion,0,1000);
                    break;
                default:
                    mtp = new ModeloTablaCompania();
            }
    ...
    public JAbstractModelBD getCompania()
    {
        if(cp!=null)
        {
            return (JAbstractModelBD)cp.getMaestroCompania();
        }
        return null;
    }
