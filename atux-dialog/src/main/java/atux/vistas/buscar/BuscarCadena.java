...
public class BuscarCadena extends javax.swing.JPanel {
    ...
    public BuscarCadena(int Seleccion) {
        initComponents();
        ...
        mtp = new ModeloTablaCadena(opcion);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if(!txtDato.getText().isEmpty()){            
            if(this.rbDescripcion.isSelected()){
                Condicion=" and co_compania = '" + this.codigoCompania +  "' and DE_Cadena like '%" + txtDato.getText() + "%' ";
            }else if(this.rbCodigo.isSelected()){
                Condicion=" and co_compania = '" + this.codigoCompania +  "' and co_Cadena like '%" + txtDato.getText() + "%' ";
            }
        }else{
            Condicion=" and co_compania = '" + this.codigoCompania +  "' ";
        }         
        if(opcion != -1){
            Condicion = Condicion + " and ES_Cadena = '" + Estado + "'";
        } 
        
        this.mtp = new ModeloTablaCadena(Condicion);
    ...
    public JAbstractModelBD getCadena()
    {
        if(cp!=null)
        {
            return (JAbstractModelBD)cp.getMaestroCadena();
        }
        return null;
    }
